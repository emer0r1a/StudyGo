...
The `Singleton` design pattern is applied to the StudyGo class to ensure that only one instance of the main application window exists throughout runtime. This prevents duplicate frames, centralizes navigation control, and provides global access for managing panels and study sessions consistently across the program.

| Component           | Type          | Responsibility                                                                                        |
| ------------------- | ------------- | ----------------------------------------------------------------------------------------------------- |
| **StudyGo**         | Frame         | Main application window. Handles navigation between panels and manages active study sessions, and ensures only one instance is active using the Singleton pattern.          |
